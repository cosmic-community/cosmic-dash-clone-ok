      ...
      <div className="flex items-center space-x-4 p-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between">
            ...
            {available ? (
              <button className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex-shrink-0">
                Add to Cart
              </button>
            ) : (
              <span className="text-gray-500 text-sm flex-shrink-0">Currently Unavailable</span>
            )}
          </div>
        </div>
      </div>
